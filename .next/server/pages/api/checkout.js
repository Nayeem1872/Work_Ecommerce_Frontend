...
/* harmony import */ var _models_Products__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3787);
...
async function handler(req, res) {
    ...
    const productsInfos = await _models_Products__WEBPACK_IMPORTED_MODULE_2__/* .Product.find */ .x.find({
        _id: unquieIds
    });
    let line_items = [];
    ...
    const orderDoc = await _models_Order__WEBPACK_IMPORTED_MODULE_1__/* .Order.create */ .K.create({
        line_items,
        name,
        email,
        city,
